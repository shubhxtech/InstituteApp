...
class _EventsPageState extends State<EventsPage> {
            ...
            BlocBuilder<PostBloc, PostState>(
              builder: (context, state) {
                if (state is PostItemsLoading ||
                  ...
                  List<PostItemEntity> eventItems = state.items
                      .where((post) => post.type == "Event")
                      .toList();
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return eventItemCard(context, index, eventItems);
                    },
  ...
  Card eventItemCard(
      BuildContext context, int index, List<PostItemEntity> eventItems) {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            DateFormat.yMMMMd()
                                .format(eventItems[index].createdAt),
              ...
              onSelected: (value) async {
                if (widget.isGuest) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'You need to login to edit/delete events.',
                        style: Theme.of(context).textTheme.labelSmall,
                      ),
                      backgroundColor: Theme.of(context).cardColor,
                    ),
                ...
                if (canEditDelete == false) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "You don't have access to edit/delete events.",
                        style: Theme.of(context).textTheme.labelSmall,
                      ),
                      backgroundColor: Theme.of(context).cardColor,
                    ),
